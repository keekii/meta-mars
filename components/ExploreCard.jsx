...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
	<motion.div
		...
		{active !== id ? (
			...
			<div className="absolute bottom-0 py-4 px-6 lg:p-8 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
				...
				<p className="font-normal text-[16px] leading-[20.16px] text-white uppercase">Enter MARS</p>
